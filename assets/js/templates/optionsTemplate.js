...
export const optionsTemplate = (type, App) => {
    ...
    tagSearchInput.classList.add( 'md:mx-1','w-[166px]', 'max-[584px]:w-vw-28', 'p-2', 'rounded', 'border', 'border-gray-300', 'mb-2', 'text-sm', 'focus:outline-none', 'focus:border-gray-600', 'placeholder-gray-500', 'self-center');
