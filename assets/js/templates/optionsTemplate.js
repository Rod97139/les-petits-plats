...
export const optionsTemplate = (type, App) => {
    ...
    tagSearchInput.classList.add('mx-2', 'md:mx-1','mt-4', 'md:mt-0', 'w-vw-24','md:w-[180px]' , 'p-2', 'rounded', 'border', 'border-gray-300', 'mb-2', 'text-sm', 'focus:outline-none', 'focus:border-gray-600', 'placeholder-gray-500');
